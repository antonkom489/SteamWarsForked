...
#include "SWAT_PlayMontageForMeshAndWaitForEvent.generated.h"

class USWAbilitySystemComponent;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FSWPlayMontageForMeshAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);

UCLASS()
class STEAMWARS_API USWAT_PlayMontageForMeshAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

	public:
	// Constructor and overrides
	USWAT_PlayMontageForMeshAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FSWPlayMontageForMeshAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FSWPlayMontageForMeshAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FSWPlayMontageForMeshAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FSWPlayMontageForMeshAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FSWPlayMontageForMeshAndWaitForEventDelegate EventReceived;
	...
	static USWAT_PlayMontageForMeshAndWaitForEvent* PlayMontageForMeshAndWaitForEvent(
...
private:
	...
	USWAbilitySystemComponent* GetTargetASC();
