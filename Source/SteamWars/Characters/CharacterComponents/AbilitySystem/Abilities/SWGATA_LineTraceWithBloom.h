...
#include "SWGATA_LineTraceWithBloom.generated.h"

class ARangeWeaponItem;

UCLASS()
class STEAMWARS_API ASWGATA_LineTraceWithBloom : public ASWGATA_Trace
{
	GENERATED_BODY()

public:
	ASWGATA_LineTraceWithBloom();

	UFUNCTION(BlueprintCallable)
	void Configure(
		UPARAM(DisplayName = "Start Location") const FGameplayAbilityTargetingLocationInfo& InStartLocation,
		UPARAM(DisplayName = "Source Weapon") ARangeWeaponItem* InSourceWeapon,
