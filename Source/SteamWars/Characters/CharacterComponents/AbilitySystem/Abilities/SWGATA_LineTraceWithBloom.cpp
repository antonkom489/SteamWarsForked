#include "SWGATA_LineTraceWithBloom.h"

#include "Actors/Equipment/Weapons/RangeWeaponItem.h"


ASWGATA_LineTraceWithBloom::ASWGATA_LineTraceWithBloom()
{
}

void ASWGATA_LineTraceWithBloom::Configure(
	const FGameplayAbilityTargetingLocationInfo& InStartLocation,
	ARangeWeaponItem* InSourceWeapon,
...
float ASWGATA_LineTraceWithBloom::GetCurrentSpread() const
{
	return SourceWeapon->GetCurrentSpread();
}

void ASWGATA_LineTraceWithBloom::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params, const FVector& TraceStart, FVector& OutTraceEnd, bool bIgnorePitch)
{
...
void ASWGATA_LineTraceWithBloom::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World, const FGameplayTargetDataFilterHandle FilterHandle, const FVector& Start, const FVector& End, FName ProfileName, const FCollisionQueryParams Params)
{
	LineTraceWithFilter(HitResults, World, FilterHandle, Start, End, ProfileName, Params);
}

void ASWGATA_LineTraceWithBloom::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType, float Duration)
{
...
void ASWGATA_LineTraceWithBloom::DrawDebugLineTraceMulti(const UWorld* World, const FVector& Start, const FVector& End, EDrawDebugTrace::Type DrawDebugType, bool bHit, const TArray<FHitResult>& OutHits, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime)
{
