...
#include "SW_PlayMontageAndWaitForEvent.generated.h"
...
UCLASS()
class STEAMWARS_API USW_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	USW_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static USW_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
