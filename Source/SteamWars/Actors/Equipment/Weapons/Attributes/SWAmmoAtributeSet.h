...
#include "SWAmmoAtributeSet.generated.h"
...
UCLASS()
class STEAMWARS_API USWAmmoAtributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(USWAmmoAtributeSet, NormalReserveAmmo)
	...
	ATTRIBUTE_ACCESSORS(USWAmmoAtributeSet, MaxHeavyReserveAmmo)
	...
	ATTRIBUTE_ACCESSORS(USWAmmoAtributeSet, SpecialReserveAmmo)
	...
	ATTRIBUTE_ACCESSORS(USWAmmoAtributeSet, MaxSpecialReserveAmmo)
